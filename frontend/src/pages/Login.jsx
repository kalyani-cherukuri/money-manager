...
// ADD THIS: Update your global AppContext so the app knows you are logged in
                setUser(response.data.user); // Or whatever your context updater function is named
