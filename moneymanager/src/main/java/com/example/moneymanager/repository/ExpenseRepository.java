...
public interface ExpenseRepository extends JpaRepository<ExpenseEntity, Long> {
    ...
    List<ExpenseEntity> findByProfileIdAndDateBetweenAndNameContainingIgnoreCase(Long profileId,LocalDate startDate,LocalDate endDate,String keyword,org.springframework.data.domain.Sort sort);
